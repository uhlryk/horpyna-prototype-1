...
describe("Testy Node transform.AdditionCombine", function() {
	...
	it('Powinien zwrócić [{"0":"v1","1":"v2"}] gdy podamy na canal_1 "v1" a na canal_2 "v2"', function (done) {
		beforeMapping1 = "v1";
		beforeMapping2 = "v2";
	...
	it('Powinien zwrócić [{"0":"v1","1":"v2"},{"0":"v3"}] gdy podamy na canal_1 ["v1","v3"] a na canal_2 "v2"', function (done) {
	...
	it('Powinien zwrócić [{"0":"v1","1":"v2"},{"0":"v3","1":"v4"}] gdy podamy na canal_1 ["v1","v3"] a na canal_2 ["v2","v4"]', function (done) {
		beforeMapping1 = ["v1","v3"];
	...
	it('Powinien zwrócić [{"0":"v1",k1:"v2",k2:"v4",k3:"v5"},{"0":"v3"}] gdy podamy na canal_1 ["v1","v3"] a na canal_2 {k1:"v2",k2:"v4",k3:"v5"}', function (done) {
		beforeMapping1 = ["v1","v3"];
	...
	it('Powinien zwrócić [{"0":"v1",k1:"v2",k2:"v4","1":"v5"},{"0":"v3"}] gdy podamy na canal_1 ["v1","v3"] a na canal_2 {k1:"v2",k2:"v4","0":"v5"}', function (done) {
		beforeMapping1 = ["v1","v3"];
